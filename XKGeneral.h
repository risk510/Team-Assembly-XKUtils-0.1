...
public:
	...
	static BOOL	ReadINIFileItem(LPCSTR INIFileName, LPCSTR INISection, LPCSTR INIItem, LPSTR ItemValue, LPLONG ValueLen);

	//Strip Quotes from a string..  add functions later to strip an char value.. 
	static void StripQuotes(LPSTR sString, LPLONG strLen);
};
