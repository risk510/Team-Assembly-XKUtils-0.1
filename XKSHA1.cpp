...
int XKSHA1::SHA1Result( SHA1Context* context, UINT8 Message_Digest[SHA1HashSize])
{
	int i;
...
int XKSHA1::SHA1Input(SHA1Context* context, const UINT8*  message_array, unsigned int length)
{
    if (!length)
    {
        return shaSuccess;
